 ...
 */
public class SendEmailActionExecuter extends ActionExecuterAbstractBase {
    private static Log logger = LogFactory.getLog(SendEmailActionExecuter.class);

    public static final String PARAM_EMAIL_TO_NAME = "recipients";
    public static final String PARAM_EMAIL_SUBJECT_NAME = "subject";
    public static final String PARAM_EMAIL_BODY_NAME = "template";
    ...
    protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
        if (serviceRegistry.getNodeService().exists(actionedUponNodeRef) == true) {
            ...
            try {
                ...
                String fromAddress = "alfresco@localhost";
